...
function QuestionsModal({ isOpen, onClose, selectedJob }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const baseUrl =
        "https://elcuvegbwtlngranjtym.supabase.co/storage/v1/object/public";
      ...
      const { error: insertError } = await supabase.from("Postulacion").insert({
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: "rgba(0, 0, 0, 0)", // Color de fondo con algo de opacidad
    ...
    >
      <div
        className="bg-white rounded-lg p-6 w-full max-w-lg relative shadow-lg h-4/5"
          ...
          {currentQuestionIndex === -1 ? (
            <div className="flex flex-col h-full justify-between">
              ...
              <div className="h-[400px]">
                <label className="w-full text-left font-semibold text-gray-600">
                Ingrese su Celular
              </label>
              <input
                type="text"
                ...
                className={`w-full mt-2 p-2 border border-gray-400 rounded focus:outline-none ${
              ...
              <label className="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                <div class="h-full w-full text-center flex flex-col justify-center items-center  ">
                  <div class="flex flex-auto max-h-48 w-2/5 mx-auto -mt-10">
                    <img
                      ...
                      src="https://static.vecteezy.com/system/resources/previews/029/455/013/non_2x/businesswoman-using-laptop-computer-upload-file-and-download-information-data-on-cloud-computing-technology-network-work-from-home-concept-illustration-vector.jpg"
                      alt="freepik image"
                    />
                  </div>
                ...
                <input
                  ...
                  className="w-full mt-2 p-2 border rounded hidden"
                />
              </label></div>
              <div className="flex justify-center h-20 w-full">
                <button
                  className={`bg-[#0057c2] text-white font-bold py-2 px-4 rounded-full h-12 w-full ${
                    phone.trim() && cvFile
                      ? ""
                      : "opacity-50 cursor-not-allowed"
                  }`}
                  onClick={() =>
                    phone.trim() && cvFile && setCurrentQuestionIndex(0)
                  } // Cambia el índice a 0 para mostrar las preguntas si el teléfono y el archivo CV no están vacíos
