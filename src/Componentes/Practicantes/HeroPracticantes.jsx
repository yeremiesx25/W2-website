  ...
  return (
    <section className="pt-28 flex flex-wrap font-dmsans md:px-12">
      <div className="w-full md:w-1/2 flex flex-col justify-center md:items-start items-center gap-6 px-4 text-center md:text-left">
        ...
        <a href="#descubre" className="bg-primarycolor p-2 text-white font-semibold rounded-lg w-80 h-14 text-lg flex items-center justify-center hover:text-primarycolor hover:border-2 hover:border-primarycolor hover:bg-white">
