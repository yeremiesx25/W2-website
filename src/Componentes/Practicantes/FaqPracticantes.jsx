...
function FaqPracticantes() {
  return (
    <section className="relative overflow-hidden bg-white pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px] px-4">
      <div className="container mx-auto">
          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
              ...
              <p className="text-base text-body-color dark:text-dark-6">
                Algunas de las dudas más comunes que tienen los pustulantes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-1/2">
            <AccordionItem
              header="¿Las prácticas son presenciales, remotas o híbridas?"
