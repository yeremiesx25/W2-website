    ...
    <div className="flex flex-col items-center px-5 mt-20">
      ...
      <div className="flex justify-between mt-14 text-lg font-medium leading-5 text-slate-500 flex-wrap">
        <motion.button
          ...
          onClick={() => {
            document.getElementById("servicio-reclutamiento").style.display = "block";
            document.getElementById("servicio-head-hunting").style.display = "none";
            document.getElementById("servicio-outsourcing").style.display = "none";
          }}
        >
        ...
        <motion.button
          ...
          onClick={() => {
            document.getElementById("servicio-reclutamiento").style.display = "none";
            document.getElementById("servicio-head-hunting").style.display = "block";
            document.getElementById("servicio-outsourcing").style.display = "none";
          }}
        >
          <div className="flex gap-3">
        ...
        <motion.button
          ...
          onClick={() => {
            document.getElementById("servicio-reclutamiento").style.display = "none";
            document.getElementById("servicio-head-hunting").style.display = "none";
            document.getElementById("servicio-outsourcing").style.display = "block";
          }}
        >
          <div className="flex gap-3">
            <img
            ...
            <div className="flex flex-col w-[59%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col max-md:mt-10 max-md:max-w-full">
                ...
                <div className="mt-14 text-base font-medium leading-5 text-indigo-600 max-md:mt-10 max-md:max-w-full font-dmsans">
                  <a href="#" className="text-white">Lo quiero</a> {/* Link a Reclutamiento y Selección */}
                </div>
              </div>
            </div>
      ...
      {/* Head Hunting */}
      <div id="servicio-head-hunting" className="mt-2" style={{ display: "none" }}>
          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[59%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col max-md:mt-10 max-md:max-w-full">
                ...
                <div className="text-white mt-6 text-lg leading-8 text-slate-500 max-md:max-w-full font-dmsans">
                Desde la búsqueda y análisis de perfiles destacados hasta la evaluación exhaustiva y 
                contratación, nuestro equipo especializado se encarga de cada paso para garantizar 
                que encuentres a los candidatos más calificados. Confía en nuestra experiencia 
                para formar equipos sólidos que impulsen el progreso y el éxito de tu empresa.
                </div>
                <div className="mt-14 text-base font-medium leading-5 text-indigo-600 max-md:mt-10 max-md:max-w-full font-dmsans">
                  <a href="#" className="text-white">Lo quiero</a> {/* Link a la pagina de head hunting */}
                </div>
              </div>
            </div>
            <div className="flex flex-col ml-5 w-[41%] max-md:ml-0 max-md:w-full">
          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[59%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col max-md:mt-10 max-md:max-w-full">
                ...
                <div className="text-white mt-6 text-lg leading-8 text-slate-500 max-md:max-w-full font-dmsans">
                Optimizamos tus operaciones mediante la externalización estratégica de funciones clave, desde la 
                identificación de necesidades hasta la gestión eficiente de recursos humanos y tecnológicos. 
                Confía en nuestro equipo para potenciar la eficacia y la flexibilidad de tu organización.
                </div>
                <div className="mt-14 text-base font-medium leading-5 text-indigo-600 max-md:mt-10 max-md:max-w-full font-dmsans">
                  <a href="#" className="text-white">Lo quiero</a> {/* Link a la pagina de outsourcing */}
                </div>
              </div>
            </div>
            <div className="flex flex-col ml-5 w-[41%] max-md:ml-0 max-md:w-full">
