...
function MainDiv() {
  return (
    ...
    <section style={{backgroundImage: `url(${fondo})`, height: '1100px' }}
    className="pt-24 bg-white sm:pt-24 font-dmsans flex flex-col items-center bg-no-repeat bg-cover animate-fade-up">
