  ...
  return (
    <section class="bg-white dark:bg-gray-900">
      <div class="container px-6 py-10 mx-auto">
        <h1 class="text-4xl font-semibold text-center text-gray-800 capitalize lg:text-5xl dark:text-white">
          <img
            src={flecha}
            alt=""
        ...
        <p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
          Nuestra historia comienza con ellos. Conoce a los fundadores de
          nuestra empresa.
        </p>

        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
          <div class="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-primarycolor dark:border-gray-700 dark:hover:border-transparent">
            <img
