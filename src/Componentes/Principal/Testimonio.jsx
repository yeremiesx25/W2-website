...
function Testimonio() {
  return (
    <section className="w-full py-10 bg-primarycolor sm:py-16 lg:py-24 font-dmsans">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">Escucha lo que dicen nuestro clientes</h2>
        </div>
        ...
        <div className="grid max-w-xl grid-cols-1 mx-auto mt-8 text-center lg:max-w-full sm:mt-12 lg:mt-20 lg:grid-cols-3 gap-x-6 xl:gap-x-12 gap-y-6">
            <div className="overflow-hidden bg-white rounded-md shadow">
                <div className="px-8 py-12">
                    <div className="relative w-24 h-24 mx-auto">
                        <img className="relative object-cover w-24 h-24 mx-auto rounded-full" src={redondos} alt="" />
                    ...
                    <blockquote className="mt-7">
                        <p className="text-lg text-black">“Gracias a W2, hemos mejorado la calidad de nuestros candidatos con un enfoque personalizado y un profundo conocimiento del mercado laboral, encontrando talento excepcional que se adapta perfectamente a nuestras necesidades.”</p>
                    </blockquote>
                    <p className="text-base font-semibold tex-tblack mt-9">Alexander Torres</p>
                    <p className="mt-1 text-base text-gray-600">CEO de Inversiones La Cruz</p>
                </div>
            </div>
            ...
            <div className="overflow-hidden bg-white rounded-md shadow">
                <div className="px-8 py-12">
                    ...
                    <blockquote className="mt-7">
                        <p className="text-lg text-black">“Desde que comenzamos a trabajar con W2, hemos experimentado un cambio significativo en la calidad de los candidatos que recibimos para nuestras posiciones vacantes. Su enfoque personalizado y su profundo conocimiento del mercado laboral nos han ayudado a encontrar talento excepcional que se adapta perfectamente a nuestras necesidades.”</p>
                    </blockquote>
