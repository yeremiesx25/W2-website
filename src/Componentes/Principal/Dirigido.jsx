...
de atracción incluso si no tienen CV. </p>
    ...
    <button class="absolute inset-x-5 bottom-8 py-3 rounded-2xl font-semibold bg-amber-400 shadow-lg hidden transition duration-200 hover:bg-gray-300 group-hover:block">Ofertas Laborales</button>
</div>
<div class="relative h-96 w-96 mx-auto px-5 py-8 group rounded-3xl bg-gray-200 overflow-hidden shadow-xl">
