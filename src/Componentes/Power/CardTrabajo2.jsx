  ...
  return (
    <div className='w-full flex justify-center font-dmsans'>
      <button
        ...
        className={`w-full md:w-[90%] bg-white text-left border hover:shadow-md rounded-lg p-4 overflow-hidden ${
      ...
      >
        <div>
          ...
          <div className="text-sm" style={{ fontWeight: '600', color: '#333' }}>{empresa}</div>
          <div className="my-2 text-xs uppercase font-semibold tracking-wide" style={{ color: '#666' }}>
            {ubicacion}
          </div>
