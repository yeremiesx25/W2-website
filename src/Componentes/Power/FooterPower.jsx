...
function FooterPower() {
  return (
    <div>
      <footer className="px-4 divide-y bg-[#1f2937] text-[#9ca3af] font-dmsans">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              <a
                rel="noopener noreferrer"
                href="https://www.facebook.com/W2AsesoresYConsultores"
                title="Facebook"
              ...
              <a
                rel="noopener noreferrer"
                href="https://www.linkedin.com/company/w2-asesores-y-consultores/posts?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3Br9ASrNlrRQ6Pnv2CZujSyw%3D%3D"
                title="LinkedIn"
                className="flex items-center p-1"
              >
                <svg
              ...
              <a
                rel="noopener noreferrer"
                href="https://www.instagram.com/w2asesoresyconsultores/"
                title="Instagram"
                className="flex items-center p-1"
              >
                <svg
              ...
              <a
                rel="noopener noreferrer"
                href="https://www.tiktok.com/@w2asesoresyconsultores"
                title="TikTok"
                className="flex items-center p-1"
              >
                <svg
              ...
              <a
                rel="noopener noreferrer"
                href="https://www.youtube.com/channel/UCW2AsesoresYConsultores"
                title="YouTube"
                className="flex items-center p-1"
              >
                <svg
