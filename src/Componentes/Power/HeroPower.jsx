...
function HeroPower() {
  return (
    <div className='flex flex-col items-center justify-center w-full h-auto font-dmsans pt-24 pb-12 text-white bg-primarytext'>
        <h1 className='text-3xl md:text-5xl font-semibold mb-4 text-center px-2 animate-fade-right'>Descubre nuestro programa Power</h1>
        <p className='mb-4 text-center px-2 animate-fade-right'>Programa de postulación basado en el apoyo de búsqueda de trabajo</p>
