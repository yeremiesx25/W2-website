  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center pt-16">
      <div className="rounded-lg p-6 w-full">
        <h2 className="text-xl font-semibold mb-4 text-center text-white">Crea una oferta con IA</h2>


        <div className="flex flex-col items-center">
          <div className="response mt-4 text-center h-80 overflow-y-scroll w-full bg-white rounded text-gray-600">
